...
public class RobotContainer {
  ...
  new TeleopSwerve(
    ...
    private void configureButtonBindings() {
        ...
        operator.y().whileTrue(new ParallelCommandGroup(new InstantCommand(() -> s_Intake.setIntakeSpeed(1)).alongWith(s_Pivot.pivotDown()).alongWith(new LimitSwitch(s_Intake))));
